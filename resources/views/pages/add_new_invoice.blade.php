...
@section('content')
  <nav class="navbar navbar-expand-lg navbar-light bg-light" style="border-bottom: 1px solid #ddd;">
            <div class="container-fluid">
              <a class="navbar-brand" href="#">New Invoice</a>
          ...
          <div class="container-fluid">  <!---MAIN CONTENT--->
            ...
            <form>               
                ...
                <div class="row mb-3">
                  <label for="inputPassword3" class="col-sm-2 col-form-label">Invoice Number</label>
                  <div class="col-sm-6">
                ...
                <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Invoice Date</label>
                    <div class="col-sm-6">
                      <input type="date" class="form-control form-control-sm" id="inputPassword3">
                    </div>
                  </div>
                  ...
                  <div class="row g-3 mb-3">
                    ...
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Invoice Date</label>
                    <div class="col-sm-3">
                      <input type="date" class="form-control form-control-sm"  aria-label="State">
                    </div>
                    <label for="inputPassword3" class="col-sm-1 col-form-label">Terms</label>
                    <div class="col-sm-3">
                      ...
                      <select class="form-select form-select-sm" id="autoSizingSelect">
                        ...
                        <option value="3">Due on end of month</option>
                      </select>
                    </div>
                    <label for="inputPassword3" class="col-sm-1 col-form-label">Due</label>
                    <div class="col-sm-2">
                      <input type="text" class="form-control form-control-sm" placeholder="Due Date" aria-label="Zip">
                    </div>
                  </div>
                  <hr>
                  ...
                  <div class="row g-3 mb-3">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Sales Person</label>
                    <div class="col-sm-4">
                      
                      <select class="form-select form-select-sm" id="autoSizingSelect">
                        <option selected>--Select or Add Sales Person--</option>
                        <option value="1">Sarawiwa Khan</option>
                        <option value="2">Mandisa Mandisa</option>
                  ...
                  <div class="row g-3 mb-3">
                    ...
                    <div class="col-sm-4">
                      ...
                      <select class="form-select form-select-sm" id="autoSizingSelect">
                        ...
                        <option value="1">Load Balance Metering</option>
