...
@section('content')
  <nav class="navbar navbar-expand-lg navbar-light bg-light" style="border-bottom: 1px solid #ddd;">
            <div class="container-fluid">
              <a class="navbar-brand" href="#">New Estimate</a>
          ...
          <div class="container-fluid">  <!---MAIN CONTENT--->
            ...
            <form>               
                ...
                <div class="row mb-3">
                  <label for="inputPassword3" class="col-sm-2 col-form-label">Estimate Number</label>
                  <div class="col-sm-6">
                ...
                <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    <label for="inputPassword3" class="col-sm-2 col-form-label">Estimate Date</label>
                    <div class="col-sm-6">
