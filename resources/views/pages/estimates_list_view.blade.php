  ...
  <div class="col-sm-4"><!---COL 1----->
    <div class="card"><!---CARD 1---->
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light" style="border-bottom: 1px solid #ddd;">
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                  <li class="nav-item">
                    <a class="btn btn-sm btn-secondary" href="{{url('pages.add_new_estimate')}}" role="button"><i class="fa-solid fa-plus"></i> Add New </a>
                  </li>
          ...
          <!------INVOICE LISTING----->
          <div class="container">
  <div class="row mt-2"><!---ROW CONTAINER 1-->
    <div class="col-6"><!---COL 1--->
        <span class="fw-bold">iSkill Learning (Pty) Ltd</span>
        <br>
        <span class="fw-bold"><a href="">EST - 0001 </a> | 23 Mar 2022</span>
    </div><!---/COL 1---><!---COL 2--->
    <div class="col-6 text-end">
    <span class="fw-bold"> BWP 67 990</span>
    <br>
        <span class="fw-bold"><a href="">Sent</a> <i class="fa-solid fa-envelope"></i> </span>
    </div><!---/COL 2--->

  </div><!---/ROW CONTAINER 1-->

<hr>
  <div class="row mt-2"><!---ROW CONTAINER 2-->
    <div class="col-6"><!---COL 1--->
        <span class="fw-bold">Sarawiwa Pecks (Pty) Ltd</span>
        <br>
        <span class="fw-bold"><a href="">EST - 0002 </a> | 23 Mar 2022</span>
    </div><!---/COL 1---><!---COL 2--->
    <div class="col-6 text-end">
    <span class="fw-bold"> BWP 590.00</span>
    <br>
        <span class="fw-bold"><a href="">Sent</a> <i class="fa-solid fa-envelope"></i> </span>
    </div><!---/COL 2--->
        ...
        <div class="page-tools">
            <div class="action-buttons">
                <a class="btn bg-white btn-light mx-1px text-95" href="#" data-title="Print">
                    <i class="fa-solid fa-file-pen text-primary-m1 text-120 w-2"></i>
                   Edit
                </a>
                <a class="btn bg-white btn-light mx-1px text-95" href="#" data-title="Print">
                ...
                <a class="btn bg-white btn-light mx-1px text-95" href="#" data-title="Print">
                    <i class="fa-solid fa-envelope-circle-check text-primary-m1 text-120 w-2"></i>
                    &nbsp;Send Mail
                </a>
                <a class="btn bg-white btn-light mx-1px text-95" href="#" data-title="Print">
                    <i class="fa-solid fa-file-export text-primary-m1 text-120 w-2"></i>
                 Convert to Invoice
                </a>
                ...
                <div class="row">
                    ...
                    <div class="text-95 col-sm-6 align-self-start d-sm-flex justify-content-end">
                        ...
                        <div class="text-grey-m2">
                            ...
                            <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span class="text-600 text-90">No#</span> EST 001</div>
